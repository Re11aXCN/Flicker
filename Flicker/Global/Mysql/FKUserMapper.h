...
#include "universal/mysql/base_mapper.hpp"

class FKUserMapper final : public universal::mysql::BaseMapper<FKUserEntity, std::uint32_t> {
public:
    explicit FKUserMapper(universal::mysql::ConnectionPool* connPool);
...
protected:
    ...
    constexpr std::string createTableQuery() const override;
