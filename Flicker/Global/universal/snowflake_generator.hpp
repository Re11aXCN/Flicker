/*************************************************************************************
 *
 * @ Filename     : snowflake_generator.h
 * @ Description  : generate unique ID using snowflake algorithm
 *
 * @ Version     : V1.0
 * @ Author         : Re11a
 ...
 * ======================================
*************************************************************************************/
#ifndef SNOWFLAKEGENERATOR_HPP_
#define SNOWFLAKEGENERATOR_HPP_
