 ...
 * ======================================
*************************************************************************************/
#ifndef ASIO_IOC_THREADPOOL_H_
#define ASIO_IOC_THREADPOOL_H_
 ...
 * 支持任务分发、负载均衡和异常处理
 */
class AsioIocThreadPool
{
    SINGLETON_CREATE_H(AsioIocThreadPool)
public:
    // 使用别名简化类型定义
     ...
     * @return io_context引用
     */
    AsioIocThreadPool::ioContext& getNextContext();
...
private:
     ...
     */
    void _initialize(const AsioIocThreadPoolConfig& config);
