...
public:
    ...
    UserEntity(std::uint32_t id, const std::string& uuid, const std::string& username,
        const std::string& email, const std::string& password,
    ...
    UserEntity(std::uint32_t id, std::string&& uuid, std::string&& username,
    ...
    UserEntity(const UserEntity& other) = default;
    UserEntity& operator=(const UserEntity& other) = default;

    UserEntity(UserEntity&& other) = default;
    UserEntity& operator=(UserEntity&& other) = default;
